import svgPaths from "./svg-j5rv0slmg9";
...
function Button4() {
  return (
    <div className="absolute bg-[rgba(57,128,244,0.9)] content-stretch flex items-center justify-center left-[404px] rounded-[12px] size-[80px] top-[209.75px]" data-name="Button">
...
function Button5() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center justify-center px-[86.72px] py-[25px] relative rounded-[8px] shrink-0" data-name="Button">
...
function Button6() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center justify-center pl-[67.14px] pr-[67.16px] py-[25px] relative rounded-[8px] shrink-0" data-name="Button">
      <div aria-hidden className="absolute border border-[#c6c6cd] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Margin2 />
      <Container26 />
      <Container27 />
...
function Button7() {
  return (
    <div className="bg-[#3980f4] content-stretch flex flex-col items-center justify-center pl-[85.89px] pr-[85.9px] py-[25px] relative rounded-[8px] shrink-0" data-name="Button">
      <Margin3 />
      <Container29 />
      <Container30 />
    </div>
...
function CenterMainContent() {
  return (
    <div className="absolute bg-[#f7f9fb] content-stretch flex flex-col inset-[0_64px_0_280px] isolate items-start" data-name="Center Main Content">
...
function AsideRightSidebarStudyKnowledgeShell() {
  return (
    <div className="absolute bg-white bottom-0 content-stretch flex flex-col items-start left-[1216px] pl-px top-0 w-[64px]" data-name="Aside - Right Sidebar (Study & Knowledge Shell)">
...
export default function VideoScholarRightSidebarCollapsed() {
  return (
    <div className="content-stretch flex flex-col items-start relative size-full" style={{ backgroundImage: "linear-gradient(90deg, rgb(247, 249, 251) 0%, rgb(247, 249, 251) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }} data-name="VideoScholar - Right Sidebar Collapsed">
      <AppShell />
