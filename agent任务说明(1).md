下面是一份按照老师示例风格改写的任务要求，已经把你们项目包装成 **VideoScholar：基于多 Agent 协同的视频学习与知识整理工具**。整体重点放在 **Agent 工作流、自动知识整理、教育场景落地**，避免过度强调模型训练或底层 Video-RAG 创新。
...
5. **自动生成复习问题**
   根据视频内容生成若干个问答题、选择题或简答题，用于学习检测。

6. **自动生成视频知识卡片**
   将视频主题、章节、核心知识点、关键时间点和总结内容整理成一页式学习卡片。
